    ...
    <Layout>
      ...
      >
        ...
        <div className=' flex flex-col gap-3 ' style={{ flex: 1 }}>
          ...
          >
            <BsDashLg width={"50px"} /> What We Do
            <BsDashLg />
          </Text>
          ...
          >
            ...
            startups, and established businesses optimize operations, boost
            productivity, and stay secure in the ever-evolving digital world.
            From infrastructure setup to ongoing support, our services are
            designed to meet the dynamic needs of today’s technology-driven
            enterprises.
          </Text>
        </div>
      </Box>
      <Container maxWidth='xl' component={Box} mt={"100px"}>
        <Flex wrap gap={"100px"} >
          ...
          <Text
            ...
            type='body'
          >
            At Mahorix, our services are crafted to empower your business and
            fuel success. We prioritize efficiency, innovation, and customer
      ...
      >
        <Flex className={styles.services} gap={"20px"} vertical>
          ...
          <Text type='body'>
            Security audits, firewall configuration, endpoint protection, and
            threat monitoring. Our cybersecurity services are designed to
            protect your business from evolving threats, ensuring data integrity
        ...
        <Flex className={styles.services} gap={"20px"} vertical>
          ...
          <Text type='body'>
            Our cloud services include scalable storage solutions, virtual
            servers, and seamless migration support. We ensure your business
            leverages the full potential of cloud technology, enhancing
            flexibility, collaboration, and cost-efficiency.
          </Text>
          <Image src={ArrowRight} className='self-end mt-[80px]' />
        </Flex>
        <Flex className={styles.services} gap={"20px"} vertical>
          ...
          <Text type='body'>
            Remote and on-site technical support, system upgrades, and
            troubleshooting At Mahorix, we offer remote and on-site technical
            support, system upgrades, and troubleshooting services.
          </Text>
          <Image src={ArrowRight} className='self-end mt-[80px]' />
        </Flex>
      </Container>
      <Box className={styles.ourwork}>
        <Flex vertical gap={"30px"} style={{ flex: 1 }}>
          ...
          <Text type='body'>
            ...
            success across varied business landscapes with comprehensive and
            adaptable services.
          </Text>
          <Button height='50px'>View Projects</Button>
        </Flex>
        <Flex
          component={Box}
      ...
      <Box className={styles.expertise}>
        <Box
          className='flex flex-wrap justify-between my-4 gap-4 '
          component={"div"}
        >
          <Text type='h1' color={colors.secondary1}>
            Expertise
