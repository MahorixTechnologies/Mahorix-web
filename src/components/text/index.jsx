...
//     sx?: SxProps;
// }
export const Text = ({ children, type = 'body', block, align = 'left', isLink = false, href = '', color = 'black', w, size = 'auto', weight, lh, className, sx, ...props }) => {
    ...
    return (
        <Typography
            ...
            sx={{
                ...
                color,
                width: w || 'auto',
                fontSize: `${isMobile ? `${(parseInt(size) * .77)}px` : size} !important`,
