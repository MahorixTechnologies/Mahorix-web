    ...
    return (
        <div className={styles.chooseus}>
            ...
            <div className='flex justify-center flex-wrap gap-5   xl:px-[50px] sm:px-0'>
                <MPaper width={isMobile?'100%':'30%'} justifyContent='center'  gap='20px' padding={'0 20px'} radius={'35px'} height={229}>
                ...
                <MPaper width={isMobile?'100%':'30%'} bgcolor='linear-gradient(232.88deg, #0072BC 28.46%, #8ED8F8 162.02%)'
                ...
                <MPaper width={isMobile?'100%':'30%'}  justifyContent='center' bgcolor='#E1F4FD' gap='20px' padding={'0 20px'} radius={'35px'} height={229}>
                    <Text type='h3'>
